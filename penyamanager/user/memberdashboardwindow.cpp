...
namespace PenyaManager {
    ...
    void MemberDashboardWindow::checkCreditLimit()
    {
        ...
        if (pCurrMemberPtr->m_balance < Singletons::m_creditLimit)
        {
            ...
            Singletons::m_pDialogManager->criticalMessageBox(this, tr("Your current balance is over limit (%1 €): %2 €").arg(Singletons::m_creditLimit, 0, 'f', 2).arg(pCurrMemberPtr->m_balance, 0, 'f', 2), [](){});
            return;
        } else {
